...
while(have_posts()){
    ...
    <div class="container container--narrow page-section">
      ...
      <span class="metabox__main"><?php the_time('n/j/y'); ?> &raquo; <?php echo the_title(); ?></span></p>
    </div>
        ...
        <?php
              ...
              if($relatedProfessors->have_posts()){
                  ...
                  echo '<h2 class="headline headline--medium">Related ' . get_the_title() . ' Instructors</h2>';
